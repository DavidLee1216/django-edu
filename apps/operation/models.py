...
class UserFavorite(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = verbose_name
    def get_course_full_value(self):
        courses = Course.objects.filter(id=self.fav_id).get()
...
class UserCourse(models.Model):
    ...
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"Add time")
    enroll_id = models.CharField(max_length=24, verbose_name=u"Enrollment Id")
    enrolment_created_at=models.DateTimeField(auto_now_add=True)
    class Meta:
